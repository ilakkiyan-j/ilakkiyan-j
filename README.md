...
`Jul 2026 — Aug 2026 · Virtual`

Engineering technical workflows around **LLMs, IBM Granite, Retrieval-Augmented Generation (RAG), and Agentic AI**.
...
- 🎙️ Voice input with **Vosk**
- 🔊 Voice output with **Coqui TTS**
...
`TypeScript` `Node.js` `Express` `PostgreSQL` `Prisma` `FastAPI` `RASA`
